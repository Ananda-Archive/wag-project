...
class RestController extends \CI_Controller
{
    ...
    // MESSAGE
    const LOGIN_FAILED = "User Not Found";
    const PASSWORD_FAILED = "Wrong Password";
    const VERIFIED_FAILED = "User is Not Verified";
    const REQUIRED_PARAMETERS = "REQUIRED PARAMETERS => ";
    const INSERT_SUCCESS = "Insert Success";
